      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
          {SOCIALS.map((social, i) => (
            <a key={social.platform} href={social.url} target={social.url.startsWith('mailto') ? undefined : '_blank'} rel={social.url.startsWith('mailto') ? undefined : 'noopener noreferrer'} className="reveal-up glass-card rounded-2xl p-6 gradient-border group hover:scale-[1.03] transition-all duration-300 focus:outline-none focus-visible:ring-2 focus-visible:ring-primary" style={{ transitionDelay: `${i * 80}ms` }} aria-label={`Visit Hariom Builds on ${social.platform}`}>
